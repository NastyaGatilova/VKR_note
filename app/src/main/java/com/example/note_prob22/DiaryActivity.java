...
//ее удалить потом
    private void addRecImitation(){
        ...
        Record newRec0 = new Record(0, "вмаа", "sshhs", "😰", "01 мар. 2024" );
        Record newRec1 = new Record(1, "вмаа", "sshhs", "😃", "02 мар. 2024");
        Record newRec2 = new Record(2, "вмаа", "sshhs", "🙂", "03 мар. 2024" );
        Record newRec3 = new Record(3, "вмаа", "sshhs", "🙂", "04 мар. 2024" );
        Record newRec4 = new Record(4, "вмаа", "sshhs", "😃", "05 мар. 2024" );
       Record newRec5 = new Record(5, "вмаа", "sshhs", "😃", "10 мар. 2024" );
//
       Record newRec6 = new Record(6, "вмаа", "sshhs", "😰", "13 мар. 2024" );
        Record newRec7 = new Record(7, "вмаа", "sshhs", "😃", "20 мар. 2024" );
       Record newRec8 = new Record(8, "вмаа", "sshhs", "🙂", "27 мар. 2024"  );
        Record newRec9 = new Record(9, "вмаа", "sshhs", "🙂", "28 мар. 2024"  );
        Record newRec10 = new Record(10, "вмаа", "sshhs", "😃", "29 мар. 2024"  );
        Record newRec11 = new Record(11, "вмаа", "sshhs", "😃", "30 мар. 2024"  );
//
        Record newRec12 = new Record(12, "вмаа", "sshhs", "😰", "31 мар. 2024"  );
      Record newRec13 = new Record(13, "вмаа", "sshhs", "🙂", "01 апр. 2024"  );
        Record newRec14 = new Record(14, "вмаа", "sshhs", "😰", "02 апр. 2024" );
        Record newRec15 = new Record(15, "вмаа", "sshhs", "🙂", "03 апр. 2024"  );
        Record newRec16 = new Record(16, "вмаа", "sshhs", "😰", "04 апр. 2024"  );
        Record newRec17 = new Record(17, "вмаа", "sshhs", "😰", "05 апр. 2024"  );
        Record newRec18 = new Record(18, "вмаа", "sshhs", "😰", "06 апр. 2024"  );
        Record newRec19 = new Record(19, "вмаа", "sshhs", "😰", "07 апр. 2024" );

        Record newRec20 = new Record(20, "вмаа", "sshhs", "😰", "08 апр. 2024"  );
        Record newRec21 = new Record(21, "вмаа", "sshhs", "🙂", "09 апр. 2024"  );
        Record newRec22 = new Record(22, "вмаа", "sshhs", "😰", "10 апр. 2024"  );
        Record newRec23 = new Record(23, "вмаа", "sshhs", "🙂", "11 апр. 2024"  );
        Record newRec24 = new Record(24, "вмаа", "sshhs", "😰", "12 апр. 2024" );
        Record newRec25 = new Record(25, "вмаа", "sshhs", "😰", "13 апр. 2024"  );
        Record newRec26 = new Record(26, "вмаа", "sshhs", "😰", "14 апр. 2024"  );
        Record newRec27 = new Record(27, "вмаа", "sshhs", "😰", "15 апр. 2024"  );
        Record newRec28 = new Record(28, "вмаа", "sshhs", "😰", "16 апр. 2024" );
        Record newRec29 = new Record(29, "вмаа", "sshhs", "😰", "17 апр. 2024"  );
        Record newRec30 = new Record(31, "вмаа", "sshhs", "🤩", "18 апр. 2024"  );
        Record newRec31 = new Record(32, "вмаа", "sshhs", "😡", "18 апр. 2024"  );
        Record newRec32 = new Record(33, "вмаа", "sshhs", "🙂", "18 апр. 2024" );
